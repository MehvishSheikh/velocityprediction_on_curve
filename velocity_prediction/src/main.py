...
def calculate_max_velocity(curvature, friction_coefficient=0.7):
    # Take the absolute value of the curvature to ensure it's non-negative
    curvature = abs(curvature)

    # Print the curvature value for debugging
...
# # Get the width of the undistorted image
...
#         out = cv2.VideoWriter('output_video.mp4', fourcc, 25.0, (cols, rows))
